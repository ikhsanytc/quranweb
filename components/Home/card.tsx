...
const CardHome: FC<Props> = ({ quranData }) => {
  return (
    <Link
      href={`/surat/${quranData.namaLatin}/${quranData.nomor}`}
      className="bg-gray-800 active:bg-gray-700 w-full lg:w-1/2 p-3 rounded-lg shadow mx-auto flex justify-between items-center"
    >
